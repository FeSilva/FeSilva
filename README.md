   ...
   <div style="display: inline_block"> 
      ...
      <p> Sou um desenvolvedor com mais de 11 anos de experiência, apaixonado por criar soluções tecnológicas e com foco em **desenvolvimento de software** e **tecnologias cloud**. Atuo como **Analista de Desenvolvimento** e **Líder Técnico**, guiando equipes em direção à excelência. Ao longo da minha carreira, adquiri experiência em linguagens como PHP, JavaScript, TypeScript, além de trabalhar com frameworks como Laravel, Vue.js, Angular e tecnologias como AWS.
      </p> 
   </div>
